...
**Status: SPEC ONLY — NOT IMPLEMENTED.** No code, schema change, or script exists for this yet. This document defines the architecture so a future session can build it without re-deriving the design.
